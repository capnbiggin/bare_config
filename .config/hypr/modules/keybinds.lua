...
hl.bind(main_mod .. " + SHIFT + W", hl.dsp.exec_cmd(browser2))
hl.bind(main_mod .. " + E", hl.dsp.exec_cmd(fileManager))
hl.bind(main_mod .. " + O", hl.dsp.exec_cmd(notes))
hl.bind(main_mod .. " + I", hl.dsp.exec_cmd(editor1))
hl.bind(main_mod .. " + SHIFT + I", hl.dsp.exec_cmd(editor2))
hl.bind(main_mod .. " + B", hl.dsp.exec_cmd(waybar_toggle))
hl.bind(main_mod .. " + CTRL + W", hl.dsp.exec_cmd(wallpaper))

-- Menu binds
hl.bind(main_mod .. " + D", hl.dsp.exec_cmd(menu))
hl.bind(main_mod .. " + SHIFT + D", hl.dsp.exec_cmd(capn_menu))
